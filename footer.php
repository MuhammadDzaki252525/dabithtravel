    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsetree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="footer.php">Footer</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                $id = $_GET['id'];
                $queryf = "SELECT * FROM footer";
                $resultsf = mysqli_query($connect, $queryf);
                $dataf = mysqli_fetch_assoc($resultsf);
                ?>
                <div class="container-fluid">
                    ...
                    <section>
                        <form action="proses-footer.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="gambarlama" <?= $dataf['gambar'] ?>>
                            <div class="mb-3 d-flex flex-column">
                                <label for="exampleInputPassword1" class="form-label">Logo footer</label>
                                <img src="aset/<?= $dataf['gambar'] ?>" alt="" style="width:100px;" class="mb-3   ">
                                <input type="file" class="form-control" id="fileInput" name="gambar">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Title Footer</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" value="<?= $dataf['judul'] ?>" name="judul">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Footer column 1</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="column1" value="<?= $dataf['column1'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Footer column 2</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="column2" value="<?= $dataf['column2'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Footer column 3</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="column3" value="<?= $dataf['column3'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Footer column 4</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="column4" value="<?= $dataf['column4'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Facebook Link</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="facebook" value="<?= $dataf['facebook'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Twitter Link</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="twitter" value="<?= $dataf['twitter'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Link Instagram</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="instagram" value="<?= $dataf['instagram'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Link Linked</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="linked" value="<?= $dataf['linked'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Link Youtube</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="youtube" value="<?= $dataf['youtube'] ?>">
                            </div>
