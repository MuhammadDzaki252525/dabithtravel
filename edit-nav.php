...
<body id="page-top">
    ...
    <div id="wrapper">
	    ...
	    ?>
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= $dat['link']?>?id=<?= $dat['id']?>">
            ...
            <li class="nav-item active">
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Post:</h6>
                        <a class="collapse-item active" href="setting-nav.php">NAVBAR</a>
                        <a class="collapse-item" href="create-nav.php">CREATE NAVBAR</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="container-fluid">
                    ...
                    <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Navbar</h1>
          <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
              For more information about DataTables, please visit the <a target="_blank"
				...
				<!-- DataTales Example -->
				<!--FORM -->
        <form class="container d-flex justify-content-between mt-2" action="proses-edit-nav.php" method="POST" enctype="multipart/form-data">
              <div class="w-100">
                <h1>Edit Pages</h1>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="tentang" name="tentang" value="<?= $data['tentang']?>" required>
                </div>
            <div class=" mb-3">
                <label for="exampleInputEmail1" class="form-label">Image</label>
                <input type="file" class="form-control" id="gambar" name="gambar" value="aset/<?= $data['gambar']?>">
              </div>
