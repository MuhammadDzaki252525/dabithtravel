            ...
            <li class="nav-item">
                ...
                <div id="collapsetree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collightlapse-item " href="profile.php">Profile</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow p-3"> <!--FORM -->
                        <form class="container d-flex justify-content-between mt-2" action="proses-edit-post.php" method="POST" enctype="multipart/form-data">
                            <div class="w-100">
                                <div class="mb-3">
                            ...
                            <div class="d-flex flex-column w-50 align-items-center ps-3">
                                <div class="d-flex flex-column bg-light w-100" style="transform:translate(0px, 87px);">
                                    ...
                                    <select id="publish-dropdown" name="category" id="category">
                                        ...
                                        while ($d = mysqli_fetch_array($r)) {
                                            if ($data['category'] == $d['nama']) {
                                                $select = "selected";
                                            } else {
                                                $select = "";
                                            }

                                            echo "<option $select>" . $d['nama'] . "</option>";
                                        }
                                        ?>
                                    </select>
