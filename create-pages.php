        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pt-4">
                    ...
                    <form class="container d-flex justify-content-between mt-2" action="proses-pages.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <h1 class="mb-3 text-black">Add Pages</h1>
                            <div class="bg-body-secondary w-100 p-4 rounded-4 mb-3">
                                ...
                                <div class=" mb-3">
                                    <textarea id="editor1" rows="10" cols="80" name="subsection1">
                                ...
                                <div class=" mb-3">
                                    <textarea id="editor2" rows="10" cols="80" name="subsection2">

                                </textarea>
                                </div>
                                <div class=" mb-3">
                                    <input type="file" class="form-control" id="fileInput" name="gambar2" accept="image/*">
                                </div>
                                <div class=" mb-3">
                                    <button name="submit" type="submit" class="btn btn-primary">Update</button>
                                </div>
