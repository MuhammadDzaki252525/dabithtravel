            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilitiese" class="collapse show" aria-labelledby="headingUtilitiese" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="create-team.php">Add Team</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pt-4">
                    ...
                    <h2 class="text-black h2 mb-3">Add Team</h2>
                    <!--FORM -->
                    <form class="d-flex justify-content-between mt-2 bg-white p-3 rounded" action="proses-team.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <div class="mb-3">
