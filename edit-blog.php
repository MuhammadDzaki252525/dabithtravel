        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pt-4">
                    ...
                    <form class="container d-flex justify-content-between mt-2" action="proses-edit-blog.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <div class="d-flex align-items-center justify-content-between">
                                <h1 class="mb-3 text-black">Edit blog</h1>
                            </div>
                            <div class="pb-3 d-flex align-items-center">
                                <a href=" Blog.php" class="btn btn-light shadow border border-warning text-warning">Preview</a>
                            ...
                            <input type="hidden" name="gambarlama" value="<?= $data1['gambar1'] ?>">
