        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pt-4">
                    ...
                    <form class="container d-flex justify-content-between mt-2" action="proses-edit-about.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <div class="d-flex align-items-center justify-content-between">
                                <h1 class=" mb-3 text-black">Edit About Us</h1>
                            </div>
                            <div class="pb-3 d-flex align-items-center">
                                <a href=" About.php" class="btn btn-light shadow border border-warning text-warning">Preview</a>
                            ...
                            <div class="bg-body-secondary w-100 p-4 rounded-4 mb-3">
                                ...
                                <div class=" mb-3">
                                    <input type="text" class="form-control" id="section6" name="section6">
                                </div>
                                <div class=" mb-3">
