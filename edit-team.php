    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion pt-3" id="accordionSidebar" style="background-color:#2D2727;">
            ...
            <li class="nav-item active">
                <a class="nav-link collapse" href="#" data-toggle="collapse" data-target="#collapseUtilitiese" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-user-plus"></i>
                    <span>TEAM</span>
                </a>
                <div id="collapseUtilitiese" class="collapse show" aria-labelledby="headingUtilitiese" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Team:</h6>
                        <a class="collapse-item active" href="team.php">All Team</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-4">
                    ...
                    <!-- DataTales Example -->
                    <!--FORM -->
                    <form class="container d-flex justify-content-between mt-2" action="proses-edit-team.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <div class="d-flex justify-content-between align-items-center">
                                <h1>Edit Team</h1>
                                <a href="team.php" class="btn btn-primary">Back</a>
                            </div>
                            <div class="mb-3">
                            ...
                            <textarea id="editor1" rows="10" cols="80" name="keterangan" value="<?= $data['keterangan'] ?>" required>
                    <?= $data['keterangan'] ?>
                </textarea>
                        </div>
                        <div class="d-flex flex-column w-50 align-items-center ps-3">
                            <div class="d-flex flex-column bg-light w-100" style="transform:translate(0px, 87px);">
                                <label for="" class="border ps-2 mb-2">Jabatan</label>


                                <select id="publish-dropdown" name="jabatan" class="" required>
                                    <?php
                                    $ini = ["manager", "manajemen", "CTO"];
                                    foreach ($ini as $value) {

                                        if ($value == $data['jabatan']) {
                                            $select = "selected";
                                        } else {
                                            $select = "";
                                        }
