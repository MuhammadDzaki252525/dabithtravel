            ...
            <li class="nav-item active">
                ...
                <div id="collapsetree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="logo.php">Logo</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <!--FORM -->
                    <form class="container d-flex justify-content-between mt-2" action="proses-logo.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <input type="hidden" name="gambarlama" value="<?= $data['logo'] ?>">
                            <h1>Logo</h1>
                            <div class="mb-3">
                                <input type="hidden" name="id">
                                <div class=" mb-3 d-flex flex-column">
                                    <label for="exampleInputEmail1" class="form-label">Image</label>
                                    <img src="aset/<?= $data['logo'] ?>" alt="" style="width:150px;" class="mb-3">
                                    <input type="file" class="form-control" id="fileInput" name="logo" required accept="image/*">
                                </div>
