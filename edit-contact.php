    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion pt-3" id="accordionSidebar" style="background-color:#2D2727;">
            ...
            <li class="nav-item">
                ...
                <div id="collapseteam" class="collapse" aria-labelledby="headingUtilitiese" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseU" aria-expanded="true" aria-controls="collapseUtilitiese">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid pt-4">
                    ...
                    <form class="container d-flex justify-content-between mt-2" action="proses-edit-contact.php" method="POST" enctype="multipart/form-data">
                        <div class="w-100">
                            <div class="d-flex align-items-center justify-content-between">
                                <h1 class="mb-3 text-black">Edit Contact</h1>
                            </div>
                            <div class="pb-3 d-flex align-items-center">
                                <a href=" contact.php" class="btn btn-light shadow border border-warning text-warning">Preview</a>
                            ...
                            <input type="hidden" name="gambarlama2" value="<?= $data1['gambar2'] ?>">
                            ...
                            <div class="bg-body-secondary w-100 p-4 rounded-4 mb-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="section1" name="section2" value="<?= $data1['section2'] ?>" required>
                                </div>
                                <div class=" mb-3">
                                    <textarea id="editor2" rows="10" cols="80" name="subsection2" value="<?= $data1['subsection2'] ?>" required>
                                    <?= $data1['subsection2'] ?>
                                </textarea>
                                </div>
                                <label for="exampleInputEmail1" class="form-label text-black">Maps</label>
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="maps" name="maps" value="<?= $data1['maps'] ?>" required>
                                </div>
                                <div class=" mb-3">
                                    <button name="submit" type="submit" class="btn btn-primary">Update</button>
                                </div>
