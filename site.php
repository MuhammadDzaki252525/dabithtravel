            ...
            <li class="nav-item active">
                ...
                <div id="collapsetree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="site.php">Site Title</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--FORM -->
                    <form class="container d-flex justify-content-between mt-2" action="proses-edit-site.php" method="POST" enctype="multipart/form-data">
