                                ...
                                <div class="col-lg-4">
                                    <div class="card mb-4">
                                        <div class="card-body text-center">
                                            <img src="aset/<?= $data['gambar'] ?>" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
                                            <h5 class="my-3"><?= $data['username'] ?></h5>
                                            <div class="d-flex justify-content-center mb-2">
                                                <a type="button" class="btn btn-primary" href="edit-profile.php?id=<?= $data['id'] ?>">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <p class="text-muted mb-0"><?= $data['telephone'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
